...
[![Live Demo](https://img.shields.io/badge/Demo-Plataforma_en_Línea-blue?style=for-the-badge&logo=react)](TU_LINK_AQUI)
...
## 🔗 Demo en Línea y Capturas del Sistema

* 🚀 **Plataforma desplegada en vivo:** [Visitar sitio web](TU_LINK_AQUI) *(Acceso público limitado por políticas de seguridad de la institución)*.

### 📸 Galería de Módulos e Implementación
